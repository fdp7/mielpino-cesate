        ...
        <>
                    ...
                    <div className={`max-w-7xl mx-auto px-4 ${
                        ...
                        >
                            <CardContent className="p-6">
                                ...
                                <p className="text-muted-foreground mb-4">
                                    I nostri salumi sono prodotti con ingredienti freschi e naturali, senza conservanti o additivi chimici, per garantire un gusto autentico e genuino.
                                </p>
                        ...
                        >
                            <CardContent className="p-6">
                                ...
                                <p className="text-muted-foreground mb-4">
                                    I nostri salumi sono realizzati con carni di alta qualità, provenienti da allevamenti italiani selezionati, per garantire un prodotto sicuro e di eccellenza.
                                </p>
                                <div className="flex items-center space-x-2">
            ...
            <div className={`h-screen ${currentProduct.bg_color} relative flex flex-col items-center justify-center`}>
                ...
                <div className={`w-full transition-all duration-1000 ease-in-out z-20 ${
                    ...
                    {/* SCOPRI SALUMIPINO - testo grande con link a /learn */}
                    {isMobile ? (
                        <Link
                            to="/learn-salumipino"
...
export default SalumipinoShowcase;
